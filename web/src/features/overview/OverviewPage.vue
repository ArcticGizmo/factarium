...
import type { LiveSummary, Integration, EntityFreshness, OverviewTargets } from '../../types';
...
const tiles = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      previous: null,
      spark: undefined,
      target: completionMin != null
        ? { value: completionMin, direction: 'gte' as const, label: `≥ ${completionMin}%` }
        : null
    }
  ];
});
