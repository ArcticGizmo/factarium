...
/// <summary>Tempo connector config: the numeric Jira project id to scope worklogs to, and a history floor.</summary>
public sealed record TempoSourceConfig(string? ProjectId, DateTimeOffset? SyncSince) : SourceConfig;
